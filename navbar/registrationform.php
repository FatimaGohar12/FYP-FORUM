            ...
            <div class="card-body">
                ...
                <form action="./_signuphandel.php" method="post">
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" id="signupname" name="signupname" aria-describedby="emailHelp" placeholder="Username" required>
                    ...
                    <div class="input-group mb-2">
                        <!-- wow kisi k pass agr gmail k ilawa koi email ho to create nh kr skta? -->
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" id="signupage" name="signupage" aria-describedby="emailHelp" placeholder="Age" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
