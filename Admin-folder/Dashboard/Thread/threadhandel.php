        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="../Thread/threadhandel.php" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Thread
                                    <span class="right badge badge-success">New</span>
                        ...
                        <li class="nav-item">
                            <a href="../postcomment.php/postcommenthandel.php" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Posts Comments
                                    <span class="right badge badge-success">New</span>
                            ...
                            <table class="table table-striped table-hover" id="myTable" style="text-align:center;">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $sno = $sno + 1;
                                        $thread = $row['thread_title'] ?? "No Thread of that category";
                                        $threadDesc = $row['thread_desc'] ?? "No Thread of that category";
                                        $thid  = $row['thread_id'];
                                        // $name = $row['user_email'];
...
<input type='button' id='' name ='' value='Delete' data-id='" . $thid . "' class='btn-delete-thread btn btn-danger'>
