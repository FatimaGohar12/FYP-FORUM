...
$sql = "SELECT thread.*,comments.*,users.* FROM thread LEFT JOIN comments ON comments.thread_id=thread.thread_id LEFT JOIN users on users.sno = thread.thread_user_id WHERE comments.comment_id =$updateid";
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <form action="updateHandle.php" method="POST">
                    ...
                    <input type="hidden" name="updateid" value="<?=$_REQUEST['updateid']?>">
                  ...
                  <div class="form-group">
                      <label for="title" class="control-label mx-2 ">Comment Content</label>
